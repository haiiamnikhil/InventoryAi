...
class UploadData(models.Model):
    ...
    uploadedName = models.CharField(max_length=100,unique=False,blank=False,null=True)
...
class ProductCountHistory(models.Model):
    user = models.ForeignKey(UserModel,on_delete=models.CASCADE,null=True,blank=False)
    item = models.CharField(max_length=100,unique=False,null=True,blank=False)
    count = models.BigIntegerField(null=True,blank=False,unique=False,default=0)
